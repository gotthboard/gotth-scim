...
`gotth-scim` versions independently under Semantic Versioning. A version number in
...
5. Verify exact head and tag parity at
   `github.com/gotthboard/gotth-scim` through the existing one-way push mirror.
